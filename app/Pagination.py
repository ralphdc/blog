...
class Pagination(object):
    ...
    自定义分页
    """
    def __init__(self, current_page, total_count, base_url, params, per_page_count=5, max_pager_count=10):
        try:
        ...
        ok_page = math.ceil(total_count / per_page_count)
        if current_page > ok_page:
