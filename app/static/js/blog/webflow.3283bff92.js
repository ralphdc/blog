...
/***/ function(module, exports, __webpack_require__) {
	...
	// Feature detects + browser sniffs  嗖燺嗖�
	...
	*/
	...
	function createLightbox(window, document, $) {
	  ...
	  lightbox.show = function (index) {
	    ...
	    // the video鈥檚 aspect ratio while being responsive.
	...
	Webflow.define('scroll', module.exports = function($, _) {
	  ...
	  function ready() {
	    ...
	    $doc.on('click', 'a', function(e) {
	      ...
	      // with the document鈥檚 location to only target links on this page.
...
/***/ function(module, exports, __webpack_require__) {
	...
	Webflow.define('touch', module.exports = function($, _) {
	  ...
	  function Touch(el) {
	    ...
	    function start(evt) {
	      // We don鈥檛 handle multi-touch events yet.
